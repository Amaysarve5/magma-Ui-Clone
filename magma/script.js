...
// Process text inside #page2>h1 and wrap each word in a span
document.querySelectorAll("#page2>h1").forEach((el) => {
  let clutter = "";
...
gsap.to("#page2>h1 span", { // Apply effect to wrapped spans
  scrollTrigger: {
  ...
  stagger: 0.2,
  color: `#fff` // Ensure text color change applies
});
...
// Process text inside #page2>h1 and wrap each word in a span
document.querySelectorAll("#page4>h1").forEach((el) => {
  let clutter = "";
  el.textContent.split(" ").forEach((word) => {
    clutter += `<span>${word} </span>`;
  });
...
// Animate text color on scroll
gsap.to("#page4>h1 span", { // Apply effect to wrapped spans
  scrollTrigger: {
...
document.querySelectorAll("#page6>h1").forEach((el) => {
  let clutter = "";
  el.textContent.split(" ").forEach((word) => {
    clutter += `<span>${word} </span>`;
  });
...
// Animate text color on scroll
gsap.to("#page6>h1 span", { // Apply effect to wrapped spans
  scrollTrigger: {
